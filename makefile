...
test: $(HEADER) main.cpp
	g++ -std=c++11 -g -I $(HEADER) -I $(HEADER2) -I $(HEADER3) -o test network/websearch.cpp main.cpp user.cpp -L $(LINK1) -lFestival -L $(LINK2) -ltermcap -lestools -lestbase -leststring -lncurses -lcurl
